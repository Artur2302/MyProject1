...
public class LotteryTicket {
    ...
    public static int[] generateNumbers() {
        ...
        for (int i = 0; i < LENGTH; i++) {
            ...
            sure it doesn't already exist in the array.
    ...
    public static boolean search(int[] array, int numberToSearchFor) {
        /*
        This is enhanced loop, it iterates through 'array' and each time
        ...
        for (int value : array) {
            ...
            /*
            If we've reached to this point ,then the entire array was searched
